        ...
        <div className="flex items-center">
          ...
          <button
            ...
            className={`text-2xl font-bold tracking-tight transition-all ${
              theme === "dark"
                ? "text-blue-400 hover:text-blue-300 drop-shadow-[0_0_12px_rgba(96,165,250,0.4)]"
          ...
          <div className="relative">
            ...
            >
              <svg
                ...
                className="w-5 h-5"
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 21L8.188 15.904L3.103 15.152L8.188 14.4L9 9.304L9.813 14.4L14.897 15.152L9.813 15.904Z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.071 4.929a10 10 0 00-14.142 0M1.929 12a10 10 0 000 14.142M22.071 12a10 10 0 010 14.142M4.929 19.071a10 10 0 0014.142 0" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M17.5 7.5L17 10L16.5 7.5L14 7L16.5 6.5L17 4L17.5 6.5L20 7L17.5 7.5Z" />
              </svg>
            </button>

            {accessibilityOpen && (
              <div className={`absolute right-0 mt-3 w-64 rounded-2xl border shadow-2xl p-4 z-50 ${
            ...
            {profileOpen && (
              <div className={`absolute right-0 mt-3 w-52 rounded-2xl border shadow-2xl overflow-hidden z-50 ${
                ...
                <div className={`px-4 py-3 border-b ${
                  theme === "dark" ? "border-slate-800" : "border-blue-50"
                }`}>
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 hover:bg-red-500/10 hover:text-red-500 transition-colors text-sm font-medium text-slate-400"
                >
                  Logout
                </button>
              </div>
        ...
        >
          <div className="flex justify-end mb-2 md:hidden">
            <button
              ...
              className={`text-2xl ${theme === "dark" ? "text-slate-400 hover:text-white" : "text-slate-600 hover:text-blue-700"}`}
            >
              ✕
            </button>
          </div>
          ...
          <nav className="space-y-2">
            ...
            <div className="space-y-2 pt-2">
              ...
              {sharedExpanded && !sidebarCollapsed && (
                <div className={`ml-3 border-l pl-3 space-y-1 ${theme === "dark" ? "border-slate-800" : "border-blue-100"}`}>
                  <button
                    onClick={() => {
                    ...
                    className={`w-full rounded-lg px-3 py-2 text-left transition-colors text-xs font-medium
                      ${isActive("/shared/spaces")
                        ? "text-blue-700 bg-white font-semibold border border-blue-100 shadow-sm"
          ...
          <div className={`mt-auto border-t pt-4 text-xs font-medium text-center ${
            theme === "dark" ? "border-slate-800 text-slate-500" : "border-blue-200/50 text-blue-500/60"
          }`}>
