...
from schemas import (SpaceCreate, SpaceDeleteResponse, SpaceUpdate, 
...
from service import (create_space_service,get_all_spaces_service,get_space_by_id_service,
    ...
    document_member_remove_service)
...
@router.post("/{space_id}/documents", response_model=DocumentResponse)
...
@router.post("/documents/{document_id}/members", response_model=DocumentMemberResponse)
